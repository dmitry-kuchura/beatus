...
<div class="news-form form-group form-md-line-input">
    ...
    <div class="form-group form-md-line-input">
        <div class="md-radio-inline">
            <div class="md-radio">
                <input type="radio" id="on" name="Slider[status]" value="1"
            ...
            <div class="md-radio has-error">
                <input type="radio" id="off" name="Slider[status]" value="0"
    ...
    <?php if (is_file(HOST . Url::to('/image/slider/main/' . $model['slide']))): ?>
        <div id="preview-pane">
            <div class="preview-container">
                <?php echo Html::img(Url::to('/image/slider/main/' . $model['slide']), ['style' => 'max-width: 235px;']); ?>
            </div>
        </div>
    <?php else: ?>
    ...
    <?php if (is_file(HOST . Url::to('/image/slider/bg/' . $model['bg']))): ?>
        <div id="preview-pane">
            <div class="preview-container">
                <?php echo Html::img(Url::to('/image/slider/bg/' . $model['bg']), ['style' => 'max-width: 235px;']); ?>
            </div>
        </div>
    <?php else: ?>
        <div class="form-group">
